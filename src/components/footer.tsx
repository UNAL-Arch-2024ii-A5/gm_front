          ...
          <div className="row">
            <div className="col-4">
              ...
              <div className="footer-link d-flex flex-column">
                <address className="text-white fs-6">
                  P. Sherman, <br />
                  Calle Wallaby, 42, Sidney <br />
                  Código postal: 111321
                </address>
                <a
                  href="tel:+573013382482"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +57 301 338 2482
                </a>
                <a
                  href="mailto:ing2bogoretro@gmail.com"
                  className="mt-4 d-block mb-0 text-white"
                >
                  ing2bogoretro@gmail.com
                </a>
                <div className="social_icons d-flex align-items-center gap-30 mt-4">
                  <a
                    className="text-white"
                    href="https://www.facebook.com/profile.php?id=61551709726959"
                  >
                    <BsFacebook className="fs-4" />
                  </a>
                  <a
                    className="text-white"
                    href="https://github.com/dbellol/BogoRetro"
                  >
            ...
            <div className="col-3">
              ...
              <div className="footer-link d-flex flex-column">
                ...
                <Link to="/terminos" className="text-white py-2 mb-1">
          ...
          <div className="row">
            <div className="col-12 mb-0 text-white">
              <p className="text-center">
                &copy;{new Date().getFullYear()}; Desarrollado por: Diana Bello
              </p>
            </div>
          </div>
        </div>
